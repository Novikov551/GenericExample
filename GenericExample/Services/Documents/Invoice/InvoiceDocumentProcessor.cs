...
{
    internal class InvoiceDocumentProcessor : BaseDocumentProcessor<CreateInvoiceDocumentModel, IUpdateDocumentModel>
    {
        private readonly IDocumentBuilder<CreateInvoiceDocumentModel, InvoiceDocumentAgregate> _documentBuilder;
        public InvoiceDocumentProcessor(IDocumentBuilder<CreateInvoiceDocumentModel,InvoiceDocumentAgregate> builder,
